...
namespace MyPlaylist.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.Playlists.Include("Songs").ToList());
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.ListadoCanciones = db.Songs.ToList();
            return View(playlist);
        }
        ...
        public ActionResult AddSong(int PlaylistId ,int SongId ) {
            var cmd = db.Database.SqlQuery<List<String>>("Spr_AgregarCancionPlaylist " + PlaylistId + ", " + SongId).ToList();
